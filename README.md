...
**Eén keer, in claude.ai** (werkt op Mac en Windows, geen GitHub-account nodig): klik in het
chatvenster op `+` > Add plugins > Add > Add from a repository, plak `SPAIK-io/ai-lead-skills` en
zet de plugin aan. De plugin
